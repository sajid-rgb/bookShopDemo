...
const android = require("../assets/images/android.jpg");
const bolod= require("../assets/images/bolod.jpg");
const hablu = require("../assets/images/hablu.jpg");
const think = require("../assets/images/think.jpg");
const php = require("../assets/images/php.jpg");
const numpy = require("../assets/images/numpy.png");
...
export default {
    android, bolod,hablu,think,numpy,php
    // avatar_1,
    // avatar_2,
    // avatar_3,
    // avatar_4,
